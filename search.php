...
<input autocomplete="off" type='text' id='goal' name='goal' onchange="$.post('ajax.php', { query: $('#goal').val() }, function(data) { $('#goal').attr('data-source', data); });" data-provide='typeahead'/>
